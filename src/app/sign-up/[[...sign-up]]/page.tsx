...
export default function SignUpPage() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-[300px] h-[300px] bg-amber-400/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-md space-y-6 text-center z-10">
        ...
        <div className="flex items-center justify-center gap-2 text-xs text-zinc-500">
          ...
          <span>Instant Account Activation & Encrypted Storage</span>
        </div>
      </div>
    </div>
  );
