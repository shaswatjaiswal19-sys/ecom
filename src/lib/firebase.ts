...
export const firebaseConfig = {
  ...
  projectId: (
    ...
    process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID !== "manoj-traders" &&
    !process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID.includes("example")
  ) ? process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID : "shaswat-ecom",
...
export const isMockFirebase = Boolean(
  ...
  firebaseConfig.apiKey.includes("ApiKey123456789") ||
  firebaseConfig.apiKey.includes("ManojTradersApiKey")
);
